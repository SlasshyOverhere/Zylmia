...
/**
 * @typedef {'scatter' | 'line' | 'circle' | 'bottom-strip'} AnimationPhase
 */
 ...
 * @property {AnimationPhase} phase
 * @property {{ x: number; y: number; rotation: number; scale: number; opacity: number }} target
 */
